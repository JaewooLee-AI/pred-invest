...
export default async function AdminPage() {
  ...
  const stats = [
    ...
    { label: '공지사항', count: notices.length, href: '/admin/notice', accent: 'var(--emerald)', borderTop: '#34d399' },
  ]
  ...
  const quickLinks = [
    ...
    { href: '/admin/notice', title: '공지사항 업로드', desc: 'PDF 공지사항 및 설명 업로드', accent: 'var(--emerald)' },
